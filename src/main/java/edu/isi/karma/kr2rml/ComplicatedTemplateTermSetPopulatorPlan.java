...
public class ComplicatedTemplateTermSetPopulatorPlan extends
		TemplateTermSetPopulatorPlan {
	
	Map<ColumnTemplateTerm, TemplateTermSetPopulatorPlan> nestedPlans;
	public ComplicatedTemplateTermSetPopulatorPlan(Map<ColumnTemplateTerm, HNodePath> termToPath,
	...
	private void generateComplicated() {
		...
		Map<ColumnTemplateTerm, ColumnTemplateTerm> garbageTermsToTermDependentOn = new HashMap<ColumnTemplateTerm, ColumnTemplateTerm>();
		for(ColumnTemplateTerm independentTerm : independentNestedTerms)
		{
			garbageTermsToTermDependentOn.put(independentTerm, null);
		}
		this.generateWorkers(garbageTermsToTermDependentOn);
