...
public class TestStringComparator {
	...
	public static void main(String[] args) {
		...
		String[] strs1 = {"Cassandre", "Arthur Hall", "Anderson Johnson", "Sir Anthony van Dyck", "Alfred Rudolph Waud", "Alan Stone", "Arthur North", "Alice Mason"};
		String[] strs2 = {"A. Mouron Cassandre",  "Arthur R. Hall", "John Anderson, Jr.", "Anthony van Dyck", "Alfred Waud", "Allan Stone", "Arthur Norman", "Alice Rahon"};
