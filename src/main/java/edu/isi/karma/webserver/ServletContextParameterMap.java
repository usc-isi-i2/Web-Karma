...
public class ServletContextParameterMap {
	...
	public enum ContextParameter {
		PUBLIC_RDF_ADDRESS,RDF_SOURCE_PREFIX,PUBLIC_KML_ADDRESS, KML_TRANSFER_SERVICE, WGS84_LAT_PROPERTY, WGS84_LNG_PROPERTY, POINT_POS_PROPERTY, POS_LIST_PROPERTY, POINT_CLASS, LINE_CLASS, TRAINING_EXAMPLE_MAX_COUNT
	}
