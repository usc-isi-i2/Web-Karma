...
public class AddColumnCommand extends WorksheetCommand {
	...
	public UpdateContainer doIt(Workspace workspace) throws CommandException {
		...
		try{
			...
			{
				logger.error("Add column failed to create " + newColumnName + " because it already exists!");
				return new UpdateContainer(new ErrorUpdate("Add column failed to create " + newColumnName + " because it already exists!"));					
			}		
			//get the HTable
