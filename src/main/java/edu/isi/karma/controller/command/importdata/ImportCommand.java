        ...
        private UpdateContainer handleRevision(Workspace workspace, Worksheet wsht) {
                ...
                try {
                        ...
                        Alignment alignment = AlignmentManager.Instance().getAlignment(
                                AlignmentManager.Instance().constructAlignmentId(workspace.getId(), revisionId));

                        final ErrorReport errorReport = new ErrorReport();
                        KR2RMLMappingGenerator mappingGen = new KR2RMLMappingGenerator(workspace.getOntologyManager(),
                                alignment, revisedWorksheet.getSemanticTypes(), "", "",
                                true, new ErrorReport());
                        // Write the model
                        StringWriter sw = new StringWriter();
                        PrintWriter writer = new PrintWriter(sw);
                        R2RMLMapping r2RMLMapping = mappingGen.getR2RMLMapping();
...
/*
                        ...
                        histReader.String historyStr = extractHistoryFromModel(is);
        ...
        /*
         * Copied code from ApplyHistoryFromR2RMLModelCommand!!! Check access modifiers for better solution
         */

        private String extractHistoryFromModel(InputStream r2rmlModelFile)
