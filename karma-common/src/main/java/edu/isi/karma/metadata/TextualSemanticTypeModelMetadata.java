...
public class TextualSemanticTypeModelMetadata extends KarmaUserMetadata {

	private static final Logger logger = LoggerFactory.getLogger(TextualSemanticTypeModelMetadata.class);
	
	public TextualSemanticTypeModelMetadata(ServletContextParameterMap contextParameters) throws KarmaException {
	...
	protected ContextParameter getDirectoryContextParameter() {
		return ContextParameter.TEXTUAL_SEMTYPE_MODEL_DIRECTORY;
	}

	@Override
	protected String getDirectoryPath() {
		return "textual-semantic-type-files/";
	}
