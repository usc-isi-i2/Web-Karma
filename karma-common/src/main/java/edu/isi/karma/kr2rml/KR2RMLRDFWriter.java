...
public interface KR2RMLRDFWriter {
	...
	void outputTripleWithURIObject(String subjTriplesMapId, String subjUri, String predicateUri,
			String objectUri);
	...
	void outputTripleWithLiteralObject(String subjTriplesMapId, String subjUri, String predicateUri,
			String value, String literalType);
	
	void outputQuadWithLiteralObject(String subjUri, String predicateUri,
			String value, String literalType, String graph);
	
	void outputQuadWithLiteralObject(String subjTriplesMapId, String subjUri, String predicateUri,
			String value, String literalType, String graph);
