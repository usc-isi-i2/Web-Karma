...
public class BloomFilterKR2RMLWriter implements KR2RMLRDFWriter {

	protected TriplesMapBloomFilterManager bloomFilterManager;
	protected PrintWriter output;
	
	public BloomFilterKR2RMLWriter(PrintWriter output, R2RMLMappingIdentifier mappingIdentifer)
	{
