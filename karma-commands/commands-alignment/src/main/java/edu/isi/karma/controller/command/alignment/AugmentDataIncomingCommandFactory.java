...
public class AugmentDataIncomingCommandFactory extends JSONInputCommandFactory{
	...
	public Command createCommand(HttpServletRequest request, Workspace workspace) {
		...
		return new AugmentDataIncomingCommand(getNewId(workspace), dataRepoUrl, worksheetId, columnUri, predicate, triplesMap, otherClass, hNodeId);
	}

	@Override
	public Class<? extends Command> getCorrespondingCommand() {
		// 
		return AugmentDataIncomingCommand.class;
	}
	...
	public Command createCommand(JSONArray inputJson, Workspace workspace)
		...
		AugmentDataIncomingCommand cmd = new AugmentDataIncomingCommand(getNewId(workspace), dataRepoUrl, worksheetId, columnUri, predicate, triplesMap, otherClass, hNodeId);
