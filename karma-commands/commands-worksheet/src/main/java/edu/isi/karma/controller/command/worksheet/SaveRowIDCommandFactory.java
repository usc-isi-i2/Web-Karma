...
public class SaveRowIDCommandFactory extends JSONInputCommandFactory{
	...
	public Command createCommand(HttpServletRequest request,
		...
		return new SaveRowIDCommand(getNewId(workspace), worksheetId, 
				hTableId, hNodeId);
	}
	...
	public Command createCommand(JSONArray inputJson, Workspace workspace)
		...
		SaveRowIDCommand rowCmd = new SaveRowIDCommand(getNewId(workspace), worksheetId,
				hTableId, hNodeID);
