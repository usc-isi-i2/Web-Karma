...
public class R2RMLConfig {
	...
	public static R2RMLConfig parse(ServletContext context, MultivaluedMap<String, String> formParams) throws MalformedURLException, IOException {
		...
		if(config.input != null) {
			if(formParams.containsKey(FormParameters.R2RML_URL))
			...
			if(formParams.containsKey(FormParameters.CONTEXT_URL))
			...
			if(formParams.containsKey(FormParameters.CONTENT_TYPE))
			...
			if (formParams.containsKey(FormParameters.CONTEXT_ROOT)) {
