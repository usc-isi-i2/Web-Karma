...
public class FormParameters {
	...
	//the url that points to the repository having karma directory
	public static final String REMOTE_KARMA_HOME_REPO_URL="KarmaURL";
	...
	public static final String ES_HOSTNAME = "ESHostname";
	public static final String ES_PORT = "ESPort";
	public static final String ES_TYPE = "ESType";
	public static final String ES_PROTOCOL = "ESProtocol";
